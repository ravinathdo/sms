...
insert  into `user_stockbroker_details`(`id`,`userid`,`cdsaccid`,`lable`,`value`) values (1,1,7,'Web Address','www.tikka.com'),(2,10,7,'xxx','rrrr'),(3,10,7,'RRR','TTT'),(4,10,7,'TT','TTE');
