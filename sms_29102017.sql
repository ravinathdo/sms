...
DROP TABLE IF EXISTS `broker_fund`;
...
CREATE TABLE `broker_fund` (
  ...
  PRIMARY KEY (`brokercomid`,`userid`)
...
DROP TABLE IF EXISTS `broker_fund_history`;
...
insert  into `cal`(`calid`,`transactionname`,`transcostupto50`,`transcostover50`,`units`) values (1,'Brrokerage Fee',0.65,0.3,0.02),(2,'CSE Fee',0.084,0.0525,0.01),(3,'CDS Fee',0.024,0.015,0.02),(4,'SEC Cess',0.072,0.045,0.02),(5,'SLT',0.35,0.35,0);
...
insert  into `cdsaccount`(`cdsaccid`,`userid`,`brokercomid`,`stockbrokerid`,`cdsaccno`,`opendate`) values (1,0,1,1,'101','2016-08-01'),(2,0,2,2,'102','2016-08-02'),(3,0,5,3,'105','2016-08-03'),(4,0,3,4,'104','2016-08-04'),(5,0,5,5,'6665645','2016-08-06'),(6,0,5,6,'1002','2017-09-10'),(7,10,2,7,'1002','2017-09-10'),(8,10,3,8,'1003','2017-10-07');
...
insert  into `students`(`id`,`fname`,`lname`,`date_of_birth`,`mobile`,`address`,`gender`,`added_time`) values (1,'Nimesh','Perera','0000-00-00','678000900','Colombo 2','','2016-05-01 01:33:16'),(2,'Sampath','Dushan','0000-00-00','09988999','Malabe','','2016-05-01 02:09:18'),(3,'Kasun','Dinesh','0000-00-00','8734857893','Kurunagala','','2016-05-01 02:10:52'),(4,'Damith','Nuwan','0000-00-00','0992348','Malabe','','2016-05-07 21:51:04'),(5,'Sampath','Anuradha','0000-00-00','07889888','23D Dawi Rd','','2016-05-07 21:52:43'),(6,'Sampath','Perera','0000-00-00','078662234','Malabe','','2016-06-04 23:58:40'),(7,'Ruwan','Silva','0000-00-00','34','dfkj','','2016-08-03 09:12:53');
...
insert  into `user`(`userid`,`email`,`fname`,`mname`,`lname`,`mobile`,`password`,`reqdate`,`status`,`approvedate`,`role`) values (1,'admin','Ruwanx','Sangeewa','Fernando','0778878784','86f7e437faa5a7fce15d1ddcb9eaeaea377667b8','0000-00-00 00:00:00',1,'2017-08-31','admin'),(2,'janaka@mail.com','Janaka','Sampath','Jayaweera','0714896425','123','0000-00-00 00:00:00',1,'2017-02-15','user'),(3,'ba','Samanatha','Suresh','Gunasekara','0774448962','86f7e437faa5a7fce15d1ddcb9eaeaea377667b8','0000-00-00 00:00:00',1,'2017-02-15','business_analyst'),(4,'data@sms.lk','user','user','user','0787877878','*23AE809DDACAF96AF0FD78ED04B6A265E05AA257','2017-02-20 13:30:00',1,'2017-02-27','data_entry_operator'),(5,'w','wwwwwwwww','wwwwwwwwwww','wwww','1111111','*23AE809DDACAF96AF0FD78ED04B6A265E05AA257','2017-03-02 13:30:00',0,'2017-03-04','user'),(6,'sadasd','sdasd','asd','weqwe','213123','40bd001563085fc35165329ea1ff5c5ecbdbbeef','2017-03-02 13:30:00',0,'0000-00-00',NULL),(7,'sagara@gmail.com','Sagara','Praneeth','Jayasundara','077','40bd001563085fc35165329ea1ff5c5ecbdbbeef','2017-03-15 12:30:00',1,'2017-03-16',NULL),(8,'rr','f','m','l','m','516b9783fca517eecbd1d064da2d165310b19759','2017-09-01 00:10:23',0,NULL,NULL),(9,'adm@gmail.com','Administrator','Admin','Nimda','0715833470','86f7e437faa5a7fce15d1ddcb9eaeaea377667b8','2017-09-01 00:21:46',1,NULL,'admin'),(10,'ttt','tt','t','t','3','86f7e437faa5a7fce15d1ddcb9eaeaea377667b8','2017-09-01 00:29:40',1,'2017-08-31','user'),(11,'xx','xx','xx','xx','444','86f7e437faa5a7fce15d1ddcb9eaeaea377667b8','2017-09-01 00:30:06',1,'2017-08-31','user');
...
DROP TABLE IF EXISTS `user_securities_sold`;
...
insert  into `user_securities_sold`(`id`,`secid`,`effectdate`,`qty`,`amount`,`total`,`UPTO_1`,`UPTO_2`,`UPTO_3`,`UPTO_4`,`UPTO_5`,`OVER_1`,`OVER_2`,`OVER_3`,`OVER_4`,`OVER_5`,`netamount`,`userid`,`datecreated`) values (1,6,'',3,4,'12.00',0.64,0.084,0.024,0.072,0.3,0.2,0.0525,0.015,0.045,0.3,'11.87',10,'2017-10-01 23:38:03'),(2,6,'2017-09-15',3,4,'12.00',0.64,0.084,0.024,0.072,0.3,0.2,0.0525,0.015,0.045,0.3,'11.87',10,'2017-10-01 23:54:42'),(3,6,'',3,4,'12.00',0.64,0.084,0.024,0.072,0.3,0.2,0.0525,0.015,0.045,0.3,'11.87',10,'2017-10-01 23:56:21'),(4,6,'2017-09-15',3,4,'12.00',0.64,0.084,0.024,0.072,0.3,0.2,0.0525,0.015,0.045,0.3,'11.87',10,'2017-10-02 00:00:11'),(5,6,'2017-09-15',3,4,'12.00',0.64,0.084,0.024,0.072,0.3,0.2,0.0525,0.015,0.045,0.3,'11.87',10,'2017-10-02 00:01:41'),(6,6,'2017-09-15',3,4,'12.00',0.64,0.084,0.024,0.072,0.3,0.2,0.0525,0.015,0.045,0.3,'11.87',10,'2017-10-02 00:02:55'),(7,6,'2017-09-15',3,4,'12.00',0.64,0.084,0.024,0.072,0.3,0.2,0.0525,0.015,0.045,0.3,'11.87',10,'2017-10-02 00:16:39'),(8,10,'2017-09-15',4,1500,'6000.00',0.64,0.084,0.024,0.072,0.3,0.2,0.0525,0.015,0.045,0.3,'5962.74',10,'2017-10-02 00:22:32'),(9,10,'2017-09-15',1,150,'150.00',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'146.51',10,'2017-10-02 00:23:44'),(10,5,'',3,60,'180.00',0.64,0.084,0.024,0.072,0.3,0.2,0.0525,0.015,0.045,0.3,'178.39',10,'2017-10-02 01:38:00'),(11,8,'2017-09-15',2,12,'24.00',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'23.35',10,'2017-10-02 01:42:42'),(12,8,'2017-09-15',3,12,'36.00',0.64,0.084,0.024,0.072,0.3,0.2,0.0525,0.015,0.045,0.3,'35.60',10,'2017-10-02 01:46:23'),(13,11,'2017-01-09',5,18,'90.00',0.64,0.084,0.024,0.072,0.3,0.2,0.0525,0.015,0.045,0.3,'88.99',10,'2017-10-06 19:34:36'),(14,12,'2017-10-08',5,17,'85.00',0.64,0.084,0.024,0.072,0.3,0.2,0.0525,0.015,0.045,0.3,'84.05',10,'2017-10-08 12:53:02'),(15,17,'2017-10-08',22,10,'220.00',0.64,0.084,0.024,0.072,0.3,0.2,0.0525,0.015,0.045,0.3,'218.14',10,'2017-10-08 13:00:07'),(16,17,'2017-10-08',1,10,'10.00',0.64,0.084,0.024,0.072,0.3,0.2,0.0525,0.015,0.045,0.3,'9.89',10,'2017-10-08 13:02:51'),(17,16,'',23,3,'69.00',0.64,0.084,0.024,0.072,0.3,0.2,0.0525,0.015,0.045,0.3,'68.23',10,'2017-10-08 13:03:25');
...
DROP TABLE IF EXISTS `user_stockbroker_details`;
